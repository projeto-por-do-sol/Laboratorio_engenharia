import 'package:quiosque_app/src/shared/utils/validator.dart';
...
class _CustomInputState extends State<CustomInput> {
  //Pegar valor sem mascara maskCnpj.getUnmaskedText()

  // CNPJ alfanumérico (novo formato): permite letras e números nas 12 primeiras
  // posições e nos dígitos verificadores.
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: (value) {
              ...
              if (widget.isCNPJ) {
                // CNPJ alfanumérico: validamos apenas o tamanho (14 caracteres
                // alfanuméricos), permitindo letras no novo formato.
                final somenteAlfanum =
                    valorLimpo.replaceAll(RegExp(r'[^0-9A-Za-z]'), '');
                if (somenteAlfanum.length != 14) {
